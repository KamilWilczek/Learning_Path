...
watermark_text = TextClip(
    "CFE", fontsize=watermark_size, color="white", align="West", size=(w, 30)
)
watermark_text = watermark_text.set_fps(fps)
watermark_text = watermark_text.set_duration(video_clip.reader.duration)
watermark_text = watermark_text.margin(left=10, right=10, bottom=10, opacity=0)
