...
# Get the stock quote
df = web.DataReader("TSLA", data_source='yahoo', start='2012-01-01', end='2022-01-12')
# Show the data
df
...
# Get the qoute
apple_quote = web.DataReader('TSLA', data_source='yahoo', start='2012-01-01', end='2022-01-14')
...
# Get actual price
apple_quote2 = web.DataReader('TSLA', data_source='yahoo', start='2022-01-13', end='2022-01-13')
