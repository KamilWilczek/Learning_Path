...
# Get the qoute
btc_quote = pd.read_csv(r'/home/kamil/Documents/ML/Stock_Price_Prediction_LSTM-computer_science_yt/archive/BTCUSD_day.csv')
btc_quote = btc_quote.iloc[::-1].reset_index(drop=True)

btc_quote = web.DataReader("BTC-USD", data_source='yahoo', start='2012-01-01', end='2022-01-13')
...
# Get actual price
btc_quote2 = web.DataReader("BTC-USD", data_source='yahoo', start='2022-01-13', end='2022-01-13')
