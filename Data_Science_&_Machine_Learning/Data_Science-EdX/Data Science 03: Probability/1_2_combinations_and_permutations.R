...
#the previous video. If we write this code as a function, we can use sapply() 
#to apply this function to several values of n.
...
# birthdays using several B values and plots the results. When B is large 
# enough that the estimated probability stays stable, then we have selected a 
# useful value of B.
