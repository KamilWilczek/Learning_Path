...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  2 15:32:36 2021
...
ax[1,0].scatter(y_train, y_pred_train - y_train, s=80, facecolors='none', 
                edgecolors='b')

ax[1,1].scatter(y_test, y_pred_test - y_test, s=80, facecolors='none', 
                edgecolors='r')
fig.show()
