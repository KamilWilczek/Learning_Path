...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  8 16:39:54 2021
...
ransac = linear_model.RANSACRegressor(base_estimator=LinearRegression(), 
                                      min_samples=0.7, 
...
plt.figure(figsize=(7,5))
plt.scatter(X_train[inlier_mask], y_train[inlier_mask], color='green', 
            marker='.', label='Inliers')
plt.scatter(X_train[outlier_mask], y_train[outlier_mask], color='gold', 
