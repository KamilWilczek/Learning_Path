...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 19 12:35:48 2021
...
#Wez wszystkie dane z kol 0 i odejmij srednia wylcziona ze wszystkich danych z 
#kol 0 i podziel to przez odch stand wyliczone dla wszystkich danych z tej kol
...
perceptron = Perceptron(eta=0.1, epochs=1000, is_verbose=True)
perceptron.fit(X, y)
plt.scatter(range(perceptron.epochs), perceptron.list_of_errors)

df = pd.read_csv(r"/home/kamil/Documents/ML - Mobilo/Data/iris.data", header=None)
df = df.iloc[:100, :].copy()
