...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  2 14:37:00 2021
...
ax[0].scatter(y_train, y_pred_train - y_train, s=80, facecolors='none', 
              edgecolors='b')
ax[1].scatter(y_test, y_pred_test - y_test, s=80, facecolors='none', 
              edgecolors='r')
